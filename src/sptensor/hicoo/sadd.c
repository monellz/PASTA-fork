 ...
 */
int sptSparseTensorAddScalarHiCOO(sptSparseTensorHiCOO *hiZ, sptSparseTensorHiCOO *hiX, sptValue a)
{
    sptAssert(a != 0.0);
    ...
    sptStopTimer(timer);
    comp_time = sptPrintElapsedTime(timer, "Cpu HiSpTns AddScalar");
    sptFreeTimer(timer);
