...
declare -a dev_ids=("-2" "-1" ${gpu_dev_id})
declare -a modes=("3" "4")
...
do
	...
	do
		...
		# TEW-eq
		./benchmarks/test_scripts/run_pasta_dadd_eq.sh ${apped}

		# TTV
		./benchmarks/test_scripts/run_pasta_ttv.sh ${apped}

		# TTM
		./benchmarks/test_scripts/run_pasta_ttm.sh ${apped}

		# MTTKRP
		./benchmarks/test_scripts/run_pasta_mttkrp.sh ${apped}
