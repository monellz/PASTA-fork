...
def main(argv):
	...
	fig, (ax1, ax2, ax3, ax4, ax5) = plt.subplots(nrows=1, ncols=5, figsize=(100, 6))
	...
	plot_gragh_left(ax1, plot_tensors, "TEW", np.asarray(gpu_gflops_coo), np.asarray(gpu_gflops_hicoo), np.asarray(theo_gflops_array))
...
def plot_gragh_left(ax, plot_tensors, title, o1, o2, o3):
	...
	rects5 = ax.plot(ind + mywidth, o3, color='r', lw=3, label='roofline')
