...
def main(argv):
	...
	omp_efficiency_coo = np.asarray(omp_gflops_coo) / np.asarray(predicted_gflops_mem_coo)
	omp_efficiency_hicoo = np.asarray(omp_gflops_hicoo) / np.asarray(predicted_gflops_mem_coo)
	common.print_gflops_array(omp_efficiency_coo, "omp_efficiency_coo")
	common.print_gflops_array(omp_efficiency_hicoo, "omp_efficiency_hicoo")
	print("omp_efficiency_coo average: %f" % np.average(omp_efficiency_coo))
	print("omp_efficiency_hicoo average: %f" % np.average(omp_efficiency_hicoo))
